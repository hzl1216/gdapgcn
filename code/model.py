...
class GCN(nn.Module):
    def __init__(self, node_count, node_dim, n_representation,dropout=0.2):
        ...
        # self.gc1_g = GraphConvolution(self.n_feature, self.n_hidden)
        # self.gc2_g = GraphConvolution(self.n_hidden, self.n_representation)
        # self.gc1_d = GraphConvolution(self.n_feature, self.n_hidden)
        # self.gc2_d = GraphConvolution(self.n_hidden, self.n_representation)
